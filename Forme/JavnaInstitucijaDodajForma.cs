...
{
    public partial class JavnaInstitucijaDodajForma : Form
    {
        ...
        public string VrstaInstitucije { get; private set; } = "";

        public JavnaInstitucijaDodajForma()
        {
            InitializeComponent();
            cmbVrstaInstitucije.SelectedIndex = 0;
        }
        ...
        private void btnSacuvaj_Click(object sender, EventArgs e)
        {
            ...
            if (cmbVrstaInstitucije.SelectedItem == null)
            {
                MessageBox.Show("Molimo izaberite vrstu institucije!", "Upozorenje",
                    MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            ...
            VrstaInstitucije = cmbVrstaInstitucije.SelectedItem.ToString();
            DodatniPodaciUneti = true;

            MessageBox.Show("Podaci za javnu instituciju su sačuvani!", "Info",
        ...
        private void cmbVrstaInstitucije_SelectedIndexChanged(object sender, EventArgs e)
        {
